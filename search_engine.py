...
>>>>>>> 8c54c3f2545d1a25e489ed6b89385541e07376b0
...
se_st = 'samsung note' #Search Phrase
...
final_inf_dic = sorted(b.items(), key=operator.itemgetter(1), reverse = True)
...
#
#nlp = spacy.load('en_core_web_sm')
#doc = nlp(u'Apple is looking at buying U.K. startup for $1 billion imac')
#for token in doc:
